...
def main():
    ...
    try:
        ...
        #param_dict["src_customer_sales_tbl"] = "D:\Projects\spark_data_engineering\src\main\spark\com\python\extractor\customers_raw.csv"
        import os
        ...
        extractor_dict_df = extractor.kpi_extractor(spark,param_dict)
        print("  extractor_dict_df: ", extractor_dict_df)
